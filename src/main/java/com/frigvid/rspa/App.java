...
public class App extends Application
{
    ...
    {
        FXMLLoader fxml = new FXMLLoader(App.class.getResource("app.fxml"));
        Scene scene = new Scene(fxml.load(), DEFAULT_WIDTH, DEFAULT_HEIGHT);
        stage.setTitle(DEFAULT_TITLE);
        // Minimum height and width are set here because FXML doesn't want to play nice for dynamic resizing.
